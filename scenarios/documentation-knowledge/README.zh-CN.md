...
适合: 需要和代码一起 review、version 的工程文档。

不适合: 非工程同事很难参与贡献的跨团队文档。

常见工具和做法: Markdown、MkDocs、Docusaurus、VitePress、GitHub Pages、PR review。

### 团队知识库

适合: 跨职能背景、onboarding、support playbooks 和产品决策。

不适合: 需要严格变更历史或代码 review 的关键运维步骤。
...
适合: 把长 PR 讨论、事故记录和会议记录变成第一稿。

不适合: 没核对事实、日期、owner 和开放问题就发布 summary。
